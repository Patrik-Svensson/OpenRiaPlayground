    ...
    public abstract class WebAuthenticationService : AuthenticationService
    {
        ...
        protected override IPrincipal CreateDefaultUser()
        {
            ...
            if (user == null)
            {
                try
                {
                    user = (IPrincipal)Activator.CreateInstance(this.DomainContext.UserType);
                }
                ...
                {
                    throw new InvalidOperationException(Resources.ApplicationServices_CannotInitializeUser, ex);
                }
            }
        ...
        private void InitializeDomainContext()
        {
            if (this._domainContext == null)
            {
                ...
                Assembly applicationAssembly =
                    ...
                    // Get the assembly where the authentication domain context got generated
